...
class ProjectServiceImplTest {
    ...
    void getByProjectCode_ExceptionTest() {
        ...
        //This is a stubbing. We configure the behaviors of the mocking parts in the main class. For example here we are testing getByProjectCode method but inside of it there is an operation projectRepository.findByProjectCode and to do the unit testing I must configure that method. So at below I said that method if you executed with empty string throw NoSuchElementException.
