...
class TaskServiceImplTest {
    ...
    void findById_Test(long id) {
        ...
        when(taskRepository.findById(id)).thenReturn(Optional.of(task));   // Optional<Task> Because the return of the method is optional we use this.
    ...
    //This is a new structure for testing. They change the method names but the general use is above method.
    @Test
