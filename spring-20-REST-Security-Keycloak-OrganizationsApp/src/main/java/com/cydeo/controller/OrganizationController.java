...
public class OrganizationController {
    ...
    //We use this by the @EnableGlobalMethodSecurity(jsr250Enabled = true) at the SecurityConfig. By this annotation we define the roles that can use this endpoint.
