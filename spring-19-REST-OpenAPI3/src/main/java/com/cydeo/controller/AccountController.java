...
//We create this annotations for openapi documentation. We can give the tag or tags like this. Extra if we want we can give this tag one by one above the methods.
...
public class AccountController {
    ...
    @GetMapping("/list")
    //We create this annotation for openapi documentation to give extra information.
